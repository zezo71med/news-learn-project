...
const wpgetapiIcon = createElement( 'svg', { width: 44, height: 44, viewBox: '0 0 250 250', className: 'dashicon' },
    createElement( 'path', {
        fill: 'currentColor',
...
registerBlockType("wpgetapi/endpoint-selector", {
    title: "WPGetAPI",
    ...
    edit(props) {
        ...
        const apiOptions = wpgetapi_block_editor.endpoints.map((value) => ({
            value: value.api_id,
            label: value.api_id,
        }));
        const endpointOptions = wpgetapi_block_editor.endpoints.map((value) => ({
        ...
        if (endpoint_id) {
            jsx.push(
                React.createElement( wp.serverSideRender, {
